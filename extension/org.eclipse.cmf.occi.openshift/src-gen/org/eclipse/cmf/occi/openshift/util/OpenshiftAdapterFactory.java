...
public class OpenshiftAdapterFactory extends AdapterFactoryImpl {
	...
	protected OpenshiftSwitch<Adapter> modelSwitch =
		new OpenshiftSwitch<Adapter>() {
			@Override
			public Adapter caseOcnamespace(Ocnamespace object) {
				return createOcnamespaceAdapter();
			}
			@Override
			public Adapter caseOcservicepod(Ocservicepod object) {
				return createOcservicepodAdapter();
			}
			@Override
			public Adapter caseOccontainer(Occontainer object) {
				return createOccontainerAdapter();
			}
			@Override
			public Adapter caseOcservicepodtocontainer(Ocservicepodtocontainer object) {
				return createOcservicepodtocontainerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.cmf.occi.openshift.Ocnamespace <em>Ocnamespace</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOcnamespaceAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.cmf.occi.openshift.Ocservicepod <em>Ocservicepod</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOcservicepodAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.cmf.occi.openshift.Occontainer <em>Occontainer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOccontainerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.cmf.occi.openshift.Ocservicepodtocontainer <em>Ocservicepodtocontainer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOcservicepodtocontainerAdapter() {
		return null;
	}
